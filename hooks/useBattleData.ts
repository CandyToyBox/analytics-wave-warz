      ...
      try {
        ...
        return {
          ...
          artistA: {
            ...
            color: '#06b6d4',
            avatar: data.is_quick_battle ? (data.quick_battle_artist1_audius_profile_pic || data.image_url) : data.image_url,
          ...
          artistB: {
            ...
            color: '#e879f9',
            avatar: data.is_quick_battle ? (data.quick_battle_artist2_audius_profile_pic || data.image_url) : data.image_url,
