          ...
          <div className="flex items-center gap-4 shrink-0">
            ...
            <div className="hidden md:flex bg-navy-900 rounded-lg p-1 border border-navy-800">
              <button
                ...
                className={`flex items-center gap-2 px-3 py-1.5 rounded-md text-xs font-bold transition-all ${currentView === 'grid'
              ...
              <button
                ...
                className={`flex items-center gap-2 px-3 py-1.5 rounded-md text-xs font-bold transition-all ${currentView === 'events'
                  ? 'bg-navy-800 text-white shadow-sm'
                  : 'text-ui-gray hover:text-white'
                  }`}
              >
              ...
              <button
                ...
                className={`flex items-center gap-2 px-3 py-1.5 rounded-md text-xs font-bold transition-all ${currentView === 'leaderboard'
                  ? 'bg-navy-800 text-white shadow-sm'
                  : 'text-ui-gray hover:text-white'
                  }`}
              >
            ...
            {(currentView === 'dashboard' || currentView === 'replay') && battle && (
              <>
                ...
                <button
                  ...
                  className={`flex items-center gap-2 px-3 py-1.5 rounded-lg text-xs font-bold border transition-all ${currentView === 'replay'
            ...
            <div className="flex items-center justify-between mb-2">
              ...
              <div className="bg-navy-900 p-1 rounded-lg border border-navy-800 flex gap-1">
                <button
                  ...
                  className={`px-4 py-2 rounded-md text-sm font-bold transition-all ${leaderboardTab === 'artists'
                    ? 'bg-navy-800 text-white shadow-sm'
                ...
                <button
                  ...
                  className={`px-4 py-2 rounded-md text-sm font-bold transition-all ${leaderboardTab === 'traders'
                ...
                <button
                  ...
                  className={`px-4 py-2 rounded-md text-sm font-bold transition-all ${leaderboardTab === 'quickBattles'
